    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-6 text-gray-700 text-sm leading-relaxed">
          ...
          <p><strong>Gmail data: </strong> If you enable Gmail integration, we access your email messages through the Gmail API to sync conversations with your CRM contacts. We store email content (sender, recipient, subject, body text) to display communication history on your account and contact pages. We also use Gmail send functionality to let you compose and send emails from within the CRM. We only access emails that match contacts in your CRM database. We do not access emails unrelated to your CRM contacts. You can disconnect Gmail at any time from Settings, and all synced email data will be removed from the CRM within 30 days.</p>
